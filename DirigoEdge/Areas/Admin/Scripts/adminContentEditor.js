...
adminEditor_class.prototype.initEditModulePopupEvent = function () {
    ...
    $(document).on("click", "a.adminEdit.onScreen", function (e) {
        ...
        if (winWidth > 1100) {
            ...
            $.post('/admin/modules/getmoduledata', { id: $(this).attr("data-id") }, "json")
...
adminEditor_class.prototype.initSaveModuleEvent = function() {
    ...
    $("#ConfirmAdminContentUpdate").click(function () {
        ...
        $.ajax({
            url: "admin/blog/updatemoduleshort",
            type: "POST",
            data: {
            ...
            success: function (data) {
                ...
                $("#AdminEditContentModal").modal('hide');
            },
            error: function (data) {
                common.hideAjaxLoader($editContainer);
...
adminEditor_class.prototype.refreshModuleContent = function (id) {
     ...
     */
    $.post('/admin/modules/getmoduledata', { id: id }, "json").done(function (result) {
        $html = result.html;
